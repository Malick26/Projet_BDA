...
class AddDeathCertificatePage extends StatefulWidget {
  @override
  _AddDeathCertificatePageState createState() =>
      _AddDeathCertificatePageState();
}
        ...
        child: Center(
          child: Column(
            ...
            children: [
              ...
              buildDateTextField("Date de décès", dated),
